...
const About = () => (
    <Layout>
        <div className="contained section">
            ...
            <p>Functional materials represent the key of the technological advancements of our time. Having the right material at hand has pushed the boundaries of technology, fabrication and thinking over an incredible range of applications from air and space industry, electronics, and nano science to pharmaceuticals.</p>

            <p>We apply and develop individual solutions based on data science and artificial intelligence to foster materials based technological advancements of our clients. Our approach challenges the complex constraints of our time, identifying materials satisfying the specific needs of the application while minimizing the impact on the environment and climate.</p>
